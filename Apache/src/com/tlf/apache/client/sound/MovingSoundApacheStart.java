...
public class MovingSoundApacheStart extends MovingSound
{
    private final EntityApache entityApache;
    private float field_147669_l = 0.0F;

    public MovingSoundApacheStart(EntityApache entityApache)
    {
    	super(new ResourceLocation(Apache.MODID + ":start"));
